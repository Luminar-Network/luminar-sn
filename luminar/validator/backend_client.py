"""
All HTTP calls from the validator to the Luminar backend, in one place.
"""
...
from luminar.common.auth import fetch_validator_nonce, sign_message
...
class BackendClient:
    """
    Thin HTTP client for the Luminar backend.
    """
    ...
    def __init__(self, wallet: bt.Wallet) -> None:
        ...
        self._session.headers["User-Agent"] = "luminar-validator/0.1"
